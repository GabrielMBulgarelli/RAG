...
`references/AtlasRAG/` and `references/aianytime/` are separate nested Git
repositories. Phase 1 does not modify, remove, vendor, or change the ignore
policy for either checkout. Any cleanup or tracking decision requires a separate
explicit review.
